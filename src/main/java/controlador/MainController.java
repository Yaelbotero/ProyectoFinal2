...
/**
 * Conecta la interfaz grafica con el modelo de procesamiento.
 * Recibe los eventos del usuario, le pide al modelo que procese
 * la imagen y actualiza la vista con el resultado.
 *
 * Las operaciones que tardan (filtro, descarga) se ejecutan en segundo
 * plano para que la interfaz no se congele mientras trabaja.
 *
